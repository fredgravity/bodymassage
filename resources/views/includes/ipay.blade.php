                    ...
                    <div class="modal-content">
                        ...
                        <form action="https://manage.ipaygh.com/gateway/checkout" id="ipay_checkout" method="post" name="ipay_checkout" target="_blank">
                            <div class="modal-body">
                                ...
                                <input name="merchant_key" type="hidden" value="tk_75286bb8-d484-11e8-a220-f23c9170642f">
                                <input id="merchant_code" type="hidden" value="TST000000002117">
                                <input name="source" type="hidden" value="WIDGET">
                                <input name="success_url" type="hidden" value="http://bodymassage.test/checkout/success">
                                <input name="cancelled_url" type="hidden" value="http://bodymassage.test/bookings/cart">
                                <input id="invoice_id" name="invoice_id" type="hidden" value="ORD_123456">
                                <input type="hidden" name="ipn_url"  value="{{ getenv('IPN_URL') }}">
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-group input-group">
                                            <input type="text" title="Name" name="extra_name" id="name" class="form-control" placeholder="First & Last Name" value="{{user()->fullname}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-group input-group">
                                            <input type="tel" title="Mobile Number" name="extra_mobile" id="number" class="form-control" maxlength="10" placeholder="Contact Number" value="233{{user()->phone}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-group input-group">
                                            <input type="email" name="email" id="extra_email" class="form-control" placeholder="Email" value="{{user()->email}}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-group input-group">
                                            <input type="text" name="total" class="form-control" id="total" placeholder="Amount(GH₵)" value="{{ $cart['cartTotal'] }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg">
                                        <div class="form-group input-group">
                                            <input class="form-control" type="text" name="description" id="description" placeholder="Description of Payment" value="{{ucfirst($result['product_name']) }}">
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
