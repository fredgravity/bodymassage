    ...
    <div class="grid-container fluid ">
        ...
        <div class="grid-padding-x grid-x ">
            ...
            <form action="" class="cell medium-8 float-center">
                ...
                <input type="hidden" name="token" id="card_token" value="{{ \App\Classes\CSRFToken::generate() }}">

                <div class="medium-12 cell" >
                    <button class="button success expanded hollow" id="card_submit">Pay Now! <span>@include('includes.spinner')</span></button>
                </div>
